...
const JobExperienceContent = [
    <>
    <Fade>
        <a href="https://www.esatan-tms.com/" style={{ textDecoration: 'none', color: 'inherit' }} target="_blank" rel="noopener noreferrer">
        <GlowBox>
        <EmployerDate>
    ...
    <Fade>
        <a href="https://www.cloudcall.com/" style={{ textDecoration: 'none', color: 'inherit' }} target="_blank" rel="noopener noreferrer">
        <GlowBox>
        <EmployerDate>
        <span style={{fontSize: "0.8rem", paddingRight: "1rem"}}>Sept 2021 - Sept 2022 </span>
